...
import {
  ...
  popupAvatarSelector,
  avatarAddBtn,
  popupAvatarForm} from '../utils/constants'
...
profileEditBtn.addEventListener('click', () => {
  ...
  const { userName, aboutInformation } = userInfo.getUserInfo();
...
const popupAddCard = new PopupWithForm({
  ...
  submitHandler: (cardData) => {
    ...
    api
      ...
      .then((newCard) => {
        sectionCards.addItem(createCard(newCard));
      })
      .catch((err) => {
        console.log(err);
      })
